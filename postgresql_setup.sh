...
psql "postgresql://$DB_USER:$DB_USER_PASS@localhost:5432/$DB_NAME" -q -c "CREATE TABLE users(user_id int primary key, user_name varchar(64), password varchar(64), balance_usd float(53), balance_rub float(53));"
